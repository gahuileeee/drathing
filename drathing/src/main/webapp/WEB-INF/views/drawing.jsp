...
<body>
    ...
    <div id="button-container">
        <!-- 버튼 1 -->
        <form action="/drathing/board" method="post" onsubmit="return submitDrawing()">
        ...
        <!-- 버튼 2 -->
        <form action="/drathing/keyword" >
            <button type="submit" class="button">return to keyword</button>
        </form>
    </div>
    <script type="text/javascript" src="/drathing/js/drawing2.js"></script>
</body>
</html>